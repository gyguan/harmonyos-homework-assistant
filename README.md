...
**小伴作业**是一款面向单个家庭的 HarmonyOS AI 作业管家，帮助家长完成作业导入与管理，帮助孩子按任务完成学习，并通过 AI 辅导、作业提交和家长验收形成完整闭环。
...
`老师作业 → OCR / AI 整理 → 家长确认 → 孩子学习与完成 → AI 小伴辅导 → 作业提交 → 家长验收与进度查看`

主要能力：

- **作业导入与整理**：支持文字、截图 / OCR 等方式导入老师布置的作业，由 AI 整理为结构化任务，家长确认后发布；
- **家庭作业管理**：面向单家庭、多孩子，统一管理课内作业与课外任务，可按科目、日期、类型和状态查看；
- **学习空间**：孩子按任务逐项完成作业，支持单任务计时、暂停、继续和学习过程状态管理；
- **AI 小伴辅导**：学习过程中可通过文字或拍题向 AI Tutor 提问，默认以引导思考为主，不直接替孩子完成作业；
- **作业提交**：完成作业后可上传多张作业照片，形成可追踪的 Submission；
- **家长验收**：家长可查看完成情况，对提交内容进行通过或退回订正；
- **学习进度**：家长可以查看孩子的作业完成、待处理事项和整体学习进度；
- **Phone + Tablet 适配**：基于 HarmonyOS ArkUI，Phone 保持核心流程简洁，Pad 在空间足够时提供列表 + 详情等增强布局。

产品定位保持克制：**只服务一个家庭，不扩展为学校、班级或教师 SaaS**；不做班级社交、排行榜、在线课堂或大型题库平台。AI 融入作业流程，但不取代家长确认和孩子自主学习。
