...
checks = {
    ...
    'submitted task is never presented as startable': "return '已提交'" in view_model and 'isActionable(item.status)' in view_model,
    'completed task is never presented as startable': "return '已完成'" in view_model,
